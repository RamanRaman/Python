#Доступ к элементам массива
	.data 
A:	.byte 14, 15 ,117, 19, 18                             #Программа выводит количество чисел больше заданного числа 
B:	.byte 13
C:	.byte 0
...
main:	#Программа будет запускаться с этой метки
	...
	slt $t2,$t1,$at  #Проверяет, является ли один регистр меньше другого.
	...
	sb $t5,C         #Выводит количество чисел больше заданного числа 
